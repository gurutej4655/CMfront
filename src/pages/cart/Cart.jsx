...
function Cart({ setOpenCart }) {
  ...
  useEffect(() => {
    ...
    cartData.map((element) => {
      flag = flag || !(element.qty <= element.stocksLeft);
    });
    setMax(flag);
  }, [cartData]);
              ...
              <div className="pointer-events-auto w-screen md:max-w-md">
                <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                  ...
                  <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    <div className="mt-6">
                      {max ? (
                        <span className="flex items-center justify-center rounded-md border border-transparent  text-red-500  text-base font-medium shadow-sm cursor-pointer">
                          Out of Stock
                        </span>
                      ) : (
                        <span
